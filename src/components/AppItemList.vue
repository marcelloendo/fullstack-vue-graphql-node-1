    ...
    <div class="card">
      <div class="card-body">
          ...
          <li class="list-group-item" v-for="item in items" v-bind:key="item.id">
            <div class="row">
              ...
              <div class="col-md text-right">
                <button class="btn btn-info"><span class="fa fa-trash" v-on:click="deleteItem(item)" ></span></button>
              </div>
            </div>
          </li>
        </ul>
        ...
        <div class="input-group">
          <input class="form-control" type="text" placeholder="Digite o prefixo" v-model="description" v-on:keyup.enter="addItem(type, description)"/>
